...
## Project Structure
    ...
    ├── testapiautodatamod_104674  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_104674`
...
2. Clone this repo and `cd testapiautodatamod_104674`
